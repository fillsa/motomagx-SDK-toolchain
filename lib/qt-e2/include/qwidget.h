...
class Q_EXPORT QWidget : public QObject, public QPaintDevice, public QPTF   //fox Size: $C4(QPTF不算98)
{
    Q_OBJECT
...
private:
...
#endif
    bool     Temp50;                  //fox f: $.. $50?  bool 这里缺一个,或者是QPTF缺一个
    ...
    unsigned int some_data; //int TempB8; //NestorM add some types, segmentation fault jumped
                                                                   //fox f: $.. $B8 这里缺一个
