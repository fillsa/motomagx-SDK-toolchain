/****************************************************************************
** $Id: qt/src/widgets/qtoolbutton.h   2.3.8   edited 2004-08-05 $
**
...
class Q_EXPORT QToolButton: public QButton //fox size: $118, QButton = $D4
{
    Q_OBJECT
...
private:
    ...
    QPixmap bp;    //fox f: $D4, size $14
    int bpID;      //fox f: $e8
    QPixmap sp;    //fox f: $ec
    int spID;      //fox f: $100

    QString tl;    //fox f: $104

    QToolButtonPrivate * d; //fox f: $108
    QIconSet * s, *son;     //fox f: $10C, $110

    uint utl: 1;            //fox f: $114
    uint ubp: 1;
    uint hasArrow : 1;
