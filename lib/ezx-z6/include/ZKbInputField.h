...
struct ZKbInputField
{
    ...
    enum
    {
        ...
        FIELD_OPTION_REQUEST_TEXT_CONFIRM_MSG = 0x20, 
		...
		FIELD_OPTION_COMPOSITE_OPTIONS = 0x1000,     
        FIELD_OPTION_FAVORITE_LANGUAGES = 0x2000,
		FIELD_OPTION_EMOTICON = 0x4000, 
		FIELD_OPTION_IMSTATEOBSERVER = 0x8000,
        FIELD_OPTION_FAVORITE_WRITING_SYSTEM = 0x10000, 
    };
    ...
    virtual long getOptions(int optionType = FIELD_OPTION_COMPOSITE_OPTIONS) const = 0;
}; 
