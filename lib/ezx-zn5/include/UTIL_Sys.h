...
extern "C"
{
	...
	int UTIL_GetChargeCompletedStatus();
	...
	int UTIL_GetCurrentSystemAudioPath();
	...
	int UTIL_GetSpnDisplayedStatus();
	int UTIL_GetSpnName();
	...
	void UTIL_SetCallBarringStatus(int);
	...
	void UTIL_SetChargeCompletedStatus(int);
	...
	void UTIL_SetCurrentSystemAudioPath(int);
	...
	void UTIL_SetSpnDisplayedStatus(int);
	void UTIL_SetSpnName(int);
	...
	#endif
	void UTIL_SetWifiProfileName(int);
