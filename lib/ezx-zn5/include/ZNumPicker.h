...
/*
ZNumPicker::getDownHighSelectedPixmap()@@VERSION		 // FUNC
ZNumPicker::getHighSelectedPixmap()@@VERSION		 // FUNC
ZNumPicker::getSelectedPixmap()@@VERSION		 // FUNC
ZNumPicker::getSpacingV1() const@@VERSION		 // FUNC
ZNumPicker::getStandardPixmap()@@VERSION		 // FUNC
ZNumPicker::getUpHighSelectedPixmap()@@VERSION		 // FUNC
ZNumPicker::getValue()@@VERSION		 // FUNC
*/
