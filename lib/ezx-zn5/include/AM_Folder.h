...
/*
AM_Folder::getContent(QValueList<AM_RegistryObject const*>&, bool) const@@VERSION		 // FUNC
AM_Folder::getPosition(AM_RegistryObject const*) const@@VERSION		 // FUNC
AM_Folder::isEmpty() const@@VERSION		 // FUNC
AM_Folder::isJavaEnabled() const@@VERSION		 // FUNC
*/
