...
public:
    ...
    static void sendKeyEvent(int unicode, int keycode, int modifiers, bool isPress,
			     bool autoRepeat, int steps=0);
    static void processKeyEvent(int unicode, int keycode, int modifiers, bool isPress,
				bool autoRepeat, int keyWeight=0);

    // e3831c multi-display system
...
#ifndef QT_NO_QWS_FADEBACKGROUND
    void enableFadeBackground( bool );
#endif
...
signals:
    ...
    void stopOmgRateMode(int stopStep);         //called by need stop omega rate mode
