...
public:
    ...
    // This will call gfx to draw text directly, without any calculation of wrap or size.
    // Make sure the size is enough to draw all text in str.
    void drawTextDirect( int x, int y, int w, int h, int flags, const QString& str);
