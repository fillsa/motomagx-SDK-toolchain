...
public:
    ...
    // Morphing Feature
    void setMorphMode( const MORPHING_MODE_E morphMode, const int winId ); // send command to Qt server to change morph mode of device

    // TV Out orientation Feature
    void setOrientationLandscape( const bool c_orientationLandscapeMode, const int winId ); // send command to Qt server to change orientation mode 
