...
class Q_EXPORT ZMultiLineEdit : public ZTableView                                                            
{
  ...
  public:
    ...
    void cursorPosBeforeInsert(int,int,int,int *,int *); //for input method
    ...
    void insertString_if( QPoint pos, QString text ); // add temporarily by Dong Feng for debug
...
#ifndef QT_NO_GET_CONTEXT
    void    bufferUpdate(); // for input methods
#endif
