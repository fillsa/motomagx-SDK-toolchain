...
public:
    ...
    //virtual QScreen::offScreenGfx();
    virtual QGfx * offScreenGfx();
    virtual void save();
    ...
    virtual int canFlip() const;
    virtual int QScreen::enableFlipping(QWidget*);
    virtual int QScreen::flippingEnabled() const;
    virtual int QScreen::disableFlipping();
    virtual int QScreen::back();
    virtual int QScreen::flip();
    virtual int QScreen::redirectQtToBack(bool);
