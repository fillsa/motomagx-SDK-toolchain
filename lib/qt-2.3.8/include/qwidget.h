/****************************************************************************
** $Id: qt/src/kernel/qwidget.h   2.3.8   edited 2004-08-05 $
**
...
class Q_EXPORT QWidget : public QObject, public QPaintDevice, public QPTF
{
    Q_OBJECT
...
private:
    ...
    mutable int          overlapping_children;//172  // Handle overlapping children

    int		 alloc_region_index;//176
    int		 alloc_region_revision;//180
    unsigned int some_data;//184
