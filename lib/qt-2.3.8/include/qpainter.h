...
//    void	setUnit( PaintUnit );		// NOT IMPLEMENTED!!!
  ...
  // Text drawing functions
    ...
    void drawText(int x, int y, QString const&, int len = -1, QPainter::TextDirection=NONE);
    void drawText(int x, int y, QString const&, int len = -1, int, QPainter::TextDirection=NONE);
    void drawText(int x, int y, int w, int h, int flags, QString const&, int len=-1, QRect* br=0, char**internal=0);
    //#####    void	drawText( const QPoint &, const QString &, int flags, int rotation = 0);

    void drawText( const QPoint &p, const QString &s, int len = -1);
    void QPainter::drawText( const QRect &r, int tf,
				const QString& str, int len = -1, QRect *br=0, char **i = 0);
