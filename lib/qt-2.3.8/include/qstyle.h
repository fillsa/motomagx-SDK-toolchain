/****************************************************************************
** $Id: qt/src/kernel/qstyle.h   2.3.8   edited 2004-08-05 $
**
...
virtual void drawProgressAmount(QPainter*, QRect, QRect, int, int, int, int, QColorGroup&);
virtual void drawDialogBackground(QPainter*, int, int, int, int, QBrush&);
virtual void drawLineEditBackground(QPainter*, int, int, int, int, QBrush&);
