 ...
 *
 * Date     Author    Comment
 * 10/2006  Motorola  Added board specific definitions for the Motorola
 *                    ArgonLV reference platform.
 */

#ifndef __ASM_ARM_ARCH_BOARD_ARGONLVREF_H_
#define __ASM_ARM_ARCH_BOARD_ARGONLVREF_H_
...
/*!
 * @name MXC UART ArgonLV Reference board level configurations 
 */
/*! @{ */
/*!
 ...
 */
#define MEM_SIZE                (SDRAM_MEM_SIZE - MXCIPU_MEM_SIZE - DSP_MEM_SIZE)
/*!
 ...
 */
#if defined(CONFIG_MACH_ARGONPLUSREF)
#define PBC_BASE_ADDRESS        IO_ADDRESS(CS3_BASE_ADDR)
#else
...
#endif /* __ASM_ARM_ARCH_BOARD_ARGONLVREF_H_ */
