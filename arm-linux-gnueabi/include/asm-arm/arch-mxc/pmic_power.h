...
#ifndef _PMIC_POWER_H
#define _PMIC_POWER_H

/*!
 * @defgroup PMIC_POWER  Power Driver
 * @ingroup PMIC_DRVRS
 */
...
typedef struct {
	...
	bool clk_32k_enable;	/*!< 32 kHz output buffer enable
				   during memory hold */
	t_vhold_voltage vhold_voltage;	/*!< output voltage for VHOLD */
	unsigned char mem_timer;	/*!< duration of the memory hold timer */
	bool mem_allon;		/*!< memory hold timer infinity mode,
				   If TRUE, the memory hold timer will
				   be set to infinity and the mem_timer
				   field will be ingored */
} t_pc_config;
#endif
/*!
 ...
 */
typedef enum {
	SW1 = 0,		/*!< Switch mode regulator 1 */
	SW2,			/*!< Switch mode regulator 2 */
	SW3,			/*!< Switch mode regulator 3 */
	V1,			/*!< Linear voltage regulator V1 */
	V2,			/*!< Linear voltage regulator V2 */
	V3,			/*!< Linear voltage regulator V3 */
	V4,			/*!< Linear voltage regulator V4 */
	VSIM,			/*!< Linear voltage regulator VSIM */
	V_VIB,			/*!< Linear voltage regulator V_VIB */
	VMMC,			/*!< Linear voltage regulator VMMC */
} t_sc55112_pmic_regulator;
...
} t_mc13783_pmic_regulator;

#ifndef CONFIG_MXC_MC13783_PMIC
typedef t_sc55112_pmic_regulator t_pmic_regulator;
#else
typedef t_mc13783_pmic_regulator t_pmic_regulator;
#endif

#ifdef CONFIG_MXC_PMIC_SC55112
/*!
 * @enum t_sc55112_regulator_voltage_sw1
 * @brief sc55112 Switch mode regulator SW1 output voltages.
 */
typedef enum {
	SW1_1V = 0,		/*!< 1.0 V */
	SW1_1_1V,		/*!< 1.1 V */
	...
	SW1_1_625V,		/*!< 1.625 V */
	SW1_1_875V,		/*!< 1.875 V */
} t_sc55112_regulator_voltage_sw1;

/*!
 * @enum t_sc55112_regulator_voltage_sw2
 * @brief sc55112 Switch mode regulator SW2 output voltages.
  */
typedef enum {
	SW2_1V = 0,		/*!< 1.0 V */
	SW2_1_1V,		/*!< 1.1 V */
	...
	SW2_1_625V,		/*!< 1.625 V */
	SW2_1_875V,		/*!< 1.875 V */
} t_sc55112_regulator_voltage_sw2;

/*!
 * @enum t_sc55112_regulator_voltage_sw3
 * @brief sc55112 Switch mode regulator SW2 output voltages.
 */
typedef enum {
	SW3_5_1V = 0,		/*!< 5.1 V */
	SW3_5_6V,		/*!< 5.6 V */
} t_sc55112_regulator_voltage_sw3;

/*!
 * @enum t_sc55112_regulator_voltage_v1
 * @brief sc55112 linear regulator V1 output voltages.
 */
typedef enum {
	V1_2_775V = 0,		/*!< 2.775 V */
	V1_1_2V,		/*!< 1.2 V */
	...
	V1_1_875V,		/*!< 1.875 V */
	V1_2_475V,		/*!< 2.475 V */
} t_sc55112_regulator_voltage_v1;

/*!
 * @enum t_sc55112_regulator_voltage_v2
 * @brief sc55112 linear regulator V2 output voltage, V2 has fixed
 * output voltage 2.775 volts.
 */
typedef enum {
	V2_2_775V = 0,		/*!< 2.775 V */
} t_sc55112_regulator_voltage_v2;

/*!
 * @enum t_sc55112_regulator_voltage_v3
 * @brief sc55112 linear regulator V3 output voltage.
 */
typedef enum {
	V3_2_775V = 0,		/*!< 2.775 V */
	V3_1_875V,		/*!< 1.875 V */
} t_sc55112_regulator_voltage_v3;

/*!
 * @enum t_sc55112_regulator_voltage_v4
 * @brief sc55112 linear regulator V4 output voltage, V4 has fixed
 * output voltage 2.775 volts.
 */
typedef enum {
	V4_2_775V = 0,		/*!< 2.775 V */
} t_sc55112_regulator_voltage_v4;

/*!
 * @enum t_sc55112_regulator_voltage_vsim
 * @brief sc55112 linear regulator VSIM output voltage.
 */
typedef enum {
	VSIM_1_8V = 0,		/*!< 1.8 V */
	VSIM_3V,		/*!< 3 V */
} t_sc55112_regulator_voltage_vsim;

/*!
 * @enum t_sc55112_regulator_voltage_vvib
 * @brief sc55112 linear regulator V_VIB output voltage.
 */
typedef enum {
	V_VIB_2V = 0,		/*!< 2 V */
	V_VIB_3V,		/*!< 3 V */
} t_sc55112_regulator_voltage_vvib;

/*!
 * @enum t_sc55112_regulator_voltage_vmmc
 * @brief sc55112 linear regulator VMMC output voltage.
 */
typedef enum {
	...
	VMMC_3_3V,		/*!< 3.3 V */
	VMMC_3_4V,		/*!< 3.4 V */
} t_sc55112_regulator_voltage_vmmc;

/*!
 * @union t_sc55112_regulator_voltage
 * @brief sc55112 regulator output voltages.
 */
typedef union {
	t_sc55112_regulator_voltage_sw1 sw1;	/*!< SW1 voltage */
	t_sc55112_regulator_voltage_sw2 sw2;	/*!< SW2 voltage */
	t_sc55112_regulator_voltage_sw3 sw3;	/*!< SW3 voltage */
	t_sc55112_regulator_voltage_v1 v1;	/*!< V1 voltage */
	t_sc55112_regulator_voltage_v2 v2;	/*!< V2 voltage */
	t_sc55112_regulator_voltage_v3 v3;	/*!< V3 voltage */
	t_sc55112_regulator_voltage_v4 v4;	/*!< V4 voltage */
	t_sc55112_regulator_voltage_vsim vsim;	/*!< VSIM voltage */
	t_sc55112_regulator_voltage_vvib v_vib;	/*!< V_VIB voltage */
	t_sc55112_regulator_voltage_vmmc vmmc;	/*!< VMMC voltage */
} t_sc55112_regulator_voltage;

/*!
 * Generic PMIC regulator voltage.
 */
typedef t_sc55112_regulator_voltage t_regulator_voltage;

/*!
 * @enum t_sc55112_regulator_sw_mode
 * @brief define switch mode regulator mode.
 *
 * The synchronous rectifier can be disabled (and pulse-skipping enabled)
 * to improve low
 * current efficiency. Software should disable synchronous rectifier /
 * enable the pulse
 * skipping for average loads less than approximately 30 mA,
...
typedef enum {
	SYNC_RECT = 0,
	PULSE_SKIP,
} t_sc55112_regulator_sw_mode;

/*!
 * Generic PMIC switch mode regulator mode.
 */
typedef t_sc55112_regulator_sw_mode t_regulator_sw_mode;

#endif
#ifdef CONFIG_MXC_MC13783_PMIC

/*!
 * @enum t_mc13783_regulator_voltage_sw1a
 * @brief mc13783 regulator SW1A output voltage.
 */
typedef enum {
	SW1A_0_9V = 0,		/*!< 0.900 V */
	SW1A_0_925V,		/*!< 0.925 V */
...
} t_mc13783_regulator_voltage_sw1a;

/*!
 * @enum t_mc13783_regulator_voltage_sw1b
 * @brief mc13783 regulator SW1B output voltage.
 */
typedef enum {
	SW1B_0_9V = 0,		/*!< 0.900 V */
	SW1B_0_925V,		/*!< 0.925 V */
...
} t_mc13783_regulator_voltage_sw1b;

/*!
 * @enum t_mc13783_regulator_voltage_sw2a
 * @brief mc13783 regulator SW2A output voltage.
 */
typedef enum {
	SW2A_0_9V = 0,		/*!< 0.900 V */
	SW2A_0_925V,		/*!< 0.925 V */
...
} t_mc13783_regulator_voltage_sw2a;

/*!
 * @enum t_mc13783_regulator_voltage_sw2b
 * @brief mc13783 regulator SW2B output voltage.
 */
typedef enum {
	SW2B_0_9V = 0,		/*!< 0.900 V */
	SW2B_0_925V,		/*!< 0.925 V */
...
} t_mc13783_regulator_voltage_sw2b;

/*!
 * @enum t_mc13783_regulator_voltage_sw3
 * @brief mc13783 regulator SW3 output voltage.
 */
typedef enum {
	SW3_5V = 0,		/*!< 5.0 V */
} t_mc13783_regulator_voltage_sw3;

/*!
 * @enum t_mc13783_regulator_voltage_violo
 * @brief mc13783 regulator VIOLO output voltage.
 */
typedef enum {
	VIOLO_1_2V = 0,		/*!< 1.2 V */
	VIOLO_1_3V,		/*!< 1.3 V */
	VIOLO_1_5V,		/*!< 1.5 V */
	VIOLO_1_8V,		/*!< 1.8 V */
} t_mc13783_regulator_voltage_violo;

/*!
 * @enum t_mc13783_regulator_voltage_vdig
 * @brief mc13783 regulator VDIG output voltage.
 */
typedef enum {
	VDIG_1_2V = 0,		/*!< 1.2 V */
	VDIG_1_3V,		/*!< 1.3 V */
	VDIG_1_5V,		/*!< 1.5 V */
	VDIG_1_8V,		/*!< 1.8 V */
} t_mc13783_regulator_voltage_vdig;

/*!
 * @enum t_mc13783_regulator_voltage_vgen
 * @brief mc13783 regulator VGEN output voltage.
 */
typedef enum {
	VGEN_1_2V = 0,		/*!< 1.2 V */
	VENG_1_3V,		/*!< 1.3 V */
	...
	VGEN_2_775V,		/*!< 2.775 V */
	VGEN_2_4V,		/*!< 2.4 V */
} t_mc13783_regulator_voltage_vgen;

/*!
 * @enum t_mc13783_regulator_voltage_vrfdig
 * @brief mc13783 regulator VRFDIG output voltage.
 */
typedef enum {
	VRFDIG_1_2V = 0,	/*!< 1.2 V */
	VRFDIG_1_5V,		/*!< 1.5 V */
...
} t_mc13783_regulator_voltage_vrfdig;

/*!
 * @enum t_mc13783_regulator_voltage_vrfref
 * @brief mc13783 regulator VRFREF output voltage.
 */
typedef enum {
...
} t_mc13783_regulator_voltage_vrfref;

/*!
 * @enum t_mc13783_regulator_voltage_vrfcp
 * @brief mc13783 regulator VRFCP output voltage.
 */
typedef enum {
	VRFCP_2_7V = 0,		/*!< 2.700 V */
	VRFCP_2_775V,		/*!< 2.775 V */
} t_mc13783_regulator_voltage_vrfcp;

/*!
 * @enum t_mc13783_regulator_voltage_vsim
 * @brief mc13783 regulator VSIM output voltage.
 */
typedef enum {
	VSIM_1_8V = 0,		/*!< 1.80 V */
	VSIM_2_9V,		/*!< 2.90 V */
} t_mc13783_regulator_voltage_vsim;

/*!
 * @enum t_mc13783_regulator_voltage_vesim
 * @brief mc13783 regulator VESIM output voltage.
 */
typedef enum {
	VESIM_1_8V = 0,		/*!< 1.80 V */
	VESIM_2_9V,		/*!< 2.90 V */
} t_mc13783_regulator_voltage_vesim;

/*!
 * @enum t_mc13783_regulator_voltage_vcam
 * @brief mc13783 regulator VCAM output voltage.
 */
typedef enum {
	VCAM_1_5V = 0,		/*!< 1.50 V */
	VCAM_1_8V,		/*!< 1.80 V */
	...
	VCAM_2_8V,		/*!< 2.80 V */
	VCAM_3V,		/*!< 3.00 V */
} t_mc13783_regulator_voltage_vcam;

/*!
 * @enum t_mc13783_regulator_voltage_vvib
 * @brief mc13783 regulator VVIB output voltage.
 */
typedef enum {
	VVIB_1_3V = 0,		/*!< 1.30 V */
	VVIB_1_8V,		/*!< 1.80 V */
	VVIB_2V,		/*!< 2.00 V */
	VVIB_3V,		/*!< 3.00 V */
} t_mc13783_regulator_voltage_vvib;

/*!
 * @enum t_mc13783_regulator_voltage_vrf1
 * @brief mc13783 regulator VRF1 output voltage.
 */
typedef enum {
	VRF1_1_5V = 0,		/*!< 1.500 V */
	VRF1_1_875V,		/*!< 1.875 V */
	VRF1_2_7V,		/*!< 2.700 V */
	VRF1_2_775V,		/*!< 2.775 V */
} t_mc13783_regulator_voltage_vrf1;

/*!
 * @enum t_mc13783_regulator_voltage_vrf2
 * @brief mc13783 regulator VRF2 output voltage.
 */
typedef enum {
	VRF2_1_5V = 0,		/*!< 1.500 V */
	VRF2_1_875V,		/*!< 1.875 V */
	VRF2_2_7V,		/*!< 2.700 V */
	VRF2_2_775V,		/*!< 2.775 V */
} t_mc13783_regulator_voltage_vrf2;

/*!
 * @enum t_mc13783_regulator_voltage_vmmc1
 * @brief mc13783 regulator VMMC1 output voltage.
 */
typedef enum {
	VMMC1_1_6V = 0,		/*!< 1.60 V */
	VMMC1_1_8V,		/*!< 1.80 V */
	...
	VMMC1_2_9V,		/*!< 2.90 V */
	VMMC1_3V,		/*!< 3.00 V */
} t_mc13783_regulator_voltage_vmmc1;

/*!
 * @enum t_mc13783_regulator_voltage_vmmc2
 * @brief mc13783 regulator VMMC2 output voltage.
 */
typedef enum {
	VMMC2_1_6V = 0,		/*!< 1.60 V */
	VMMC2_1_8V,		/*!< 1.80 V */
	...
	VMMC2_2_9V,		/*!< 2.90 V */
	VMMC2_3V,		/*!< 3.00 V */
} t_mc13783_regulator_voltage_vmmc2;

/*!
 * @union t_mc13783_regulator_voltage
 * @brief mc13783 regulator output voltages.
 */
typedef union {
	t_mc13783_regulator_voltage_sw1a sw1a;	/*!< SW1A voltage */
	t_mc13783_regulator_voltage_sw1b sw1b;	/*!< SW1B voltage */
	t_mc13783_regulator_voltage_sw2a sw2a;	/*!< SW2A voltage */
	t_mc13783_regulator_voltage_sw2b sw2b;	/*!< SW2B voltage */
	t_mc13783_regulator_voltage_sw3 sw3;	/*!< SW3 voltage */
	t_mc13783_regulator_voltage_violo violo;	/*!< VIOLO voltage */
	t_mc13783_regulator_voltage_vdig vdig;	/*!< VDIG voltage */
	t_mc13783_regulator_voltage_vgen vgen;	/*!< VGEN voltage */
	t_mc13783_regulator_voltage_vrfdig vrfdig;	/*!< VRFDIG voltage */
	t_mc13783_regulator_voltage_vrfref vrfref;	/*!< VRFREF voltage */
	t_mc13783_regulator_voltage_vrfcp vrfcp;	/*!< VRFCP voltage */
	t_mc13783_regulator_voltage_vsim vsim;	/*!< VSIM voltage */
	t_mc13783_regulator_voltage_vesim vesim;	/*!< VESIM voltage */
	t_mc13783_regulator_voltage_vcam vcam;	/*!< VCAM voltage */
	t_mc13783_regulator_voltage_vvib vvib;	/*!< VVIB voltage */
	t_mc13783_regulator_voltage_vrf1 vrf1;	/*!< VRF1 voltage */
	t_mc13783_regulator_voltage_vrf2 vrf2;	/*!< VRF2 voltage */
	t_mc13783_regulator_voltage_vmmc1 vmmc1;	/*!< VMMC1 voltage */
	t_mc13783_regulator_voltage_vmmc2 vmmc2;	/*!< VMMC2 voltage */
} t_mc13783_regulator_voltage;

/*!
 * @union t_mc13783_switcher_stdby
 * @brief mc13783 switcher stdby output voltages.
 */
typedef union {
	t_mc13783_regulator_voltage_sw1a sw1a;	/*!< SW1A stdby voltage */
	t_mc13783_regulator_voltage_sw1b sw1b;	/*!< SW1B stdby voltage */
	t_mc13783_regulator_voltage_sw2a sw2a;	/*!< SW2A stdby voltage */
	t_mc13783_regulator_voltage_sw2b sw2b;	/*!< SW2B stdby voltage */
} t_mc13783_switcher_dvs;

/*!
 * Generic PMIC regulator voltage.
 */
typedef t_mc13783_regulator_voltage t_regulator_voltage;

/*!
 * @enum t_mc13783_regulator_sw_mode
 * @brief define switch mode regulator mode.
 */
typedef enum {
	SYNC_RECT = 0,
	...
	PULSE_SKIP,
	LOW_POWER,
} t_mc13783_regulator_sw_mode;

/*!
 * Generic PMIC switch mode regulator mode.
 */
typedef t_mc13783_regulator_sw_mode t_regulator_sw_mode;
typedef t_mc13783_regulator_sw_mode t_regulator_stby_mode;
#endif
