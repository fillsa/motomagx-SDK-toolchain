 ...
 *   - @ref kernel_funcs_sdhc          "SDHC Control functions"
...
/*!
 * @anchor kernel_funcs_sdhc
 * @name Kernel-space SDHC Control functions
 *
 * These functions are exported by the driver to allow other kernel-space code to control
 * the SDHC.  For more information, see the documentation for the
 * sdhc_user.c file.
 */
/* @{ */
extern int __init moto_sdhc_init (void);
extern void __exit moto_sdhc_destroy (void);
/* @} End of kernel SDHC functions -------------------------------------------------------------- */
...
/*!
 * @anchor kernel_funcs_usr_blk_dev
 * @name Kernel-space User Block Device Control functions
 *
 * These functions are exported by the driver to allow other kernel-space code to control
 * the user block device.  For more information, see the documentation for the
 * usr_blk_dev.c file.
 */
/* @{ */
extern irqreturn_t usr_blk_dev_attach_irq(int irq, void *device_msk, struct pt_regs *regs);
/* @} End of kernel user block device functions ------------------------------------------------- */
